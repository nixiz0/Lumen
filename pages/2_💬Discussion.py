...
lang = get_lang()
configuration_model(lang=lang, filename_model='save_config_txt/discussion_model.txt')

st.sidebar.markdown("<hr style='margin:5px;'>", unsafe_allow_html=True)

# Get a list of all json files in the directory
history_dir = 'functions/discussion_page/discussion_history'
...
set_page_title("Discussion · Streamlit", "💬 Discussion")
custom_ui()