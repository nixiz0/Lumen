...
lang = get_lang()
configuration_model(lang=lang, filename_model='save_config_txt/vision_model.txt')

st.sidebar.markdown("<hr style='margin:5px;'>", unsafe_allow_html=True)

# Get a list of all json files in the directory
history_dir = 'functions/vision_page/vision_history'
...
set_page_title("Vision · Streamlit", "👁️ Vision")
custom_ui()