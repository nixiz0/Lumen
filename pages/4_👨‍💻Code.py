...
lang = get_lang()
configuration_model(lang=lang, filename_model='save_config_txt/code_model.txt')

st.sidebar.markdown("<hr style='margin:5px;'>", unsafe_allow_html=True)

# Get a list of all json files in the directory
history_dir = 'functions/code_page/code_history'
...
set_page_title("Code · Streamlit", "👨‍💻 Code")
custom_ui()